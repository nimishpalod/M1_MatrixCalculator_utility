...
## Badges
| Linux Build |Code Quality|
|------------|------------|
| ![Linux Build]([![C/C++ CI](https://github.com/nimishpalod/M1_MatrixCalculator_utility/actions/workflows/linuxc-cpp.yml/badge.svg)](https://github.com/nimishpalod/M1_MatrixCalculator_utility/actions/workflows/linuxc-cpp.yml))| ![Code Quality](https://api.codiga.io/project/31035/status/svg) 
 ## Refrences
 * Java TPoint
 * Educba.com
 * Wikipedia 
